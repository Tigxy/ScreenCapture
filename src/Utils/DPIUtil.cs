...
namespace ScreenCapture.Utils {
    /// <summary>
    /// From https://stackoverflow.com/a/76402250
    /// (CC BY-SA 4.0)
    /// </summary>
    public static class DPIUtil {
        ...
        public static double ScaleFactor(Control control, POINTSTRUCT monitorPoint) {
        ...
        /// <param name="monitorPoint"> Monitor point (Screen.Bounds) </param>
        /// <returns> DPI </returns>
        public static uint GetDpi(Control control, POINTSTRUCT monitorPoint) {
            uint dpiX;
        ...
        internal static extern IntPtr MonitorFromPoint([In] POINTSTRUCT pt, [In] uint dwFlags);
